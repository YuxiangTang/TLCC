...
class TLCC(nn.Module):
    def __init__(self, normalization):
        ...
        self.fc = nn.Sequential(
            ...
            nn.Conv2d(256 * 2, 64, kernel_size=6, stride=1, padding=3),
    ...
    def matrix_mormalization(self, mat, abs_mode=False):
        if abs_mode:
            mat = torch.abs(mat)
    ...
    def ill_convert(self, ill, ccm):
        ccm_inv = self.matrix_inverse(ccm)
    ...
    def forward(self, x):
        ...
        ccm = self.matrix_mormalization(ccm, abs_mode=True)
